...
<html lang="en" >
	...
	<head>
        ...
        <!--begin::Base Styles -->  
        <!--begin::Page Vendors -->
		<link href="{{ asset ('template/assets/vendors/custom/fullcalendar/fullcalendar.bundle.css')}}" rel="stylesheet" type="text/css" />
		<!--end::Page Vendors -->
		<link href="{{ asset ('template/assets/vendors/base/vendors.bundle.css')}}" rel="stylesheet" type="text/css" />
		<link href="{{ asset ('template/assets/demo/default/base/style.bundle.css')}}" rel="stylesheet" type="text/css" />
		<!--end::Base Styles -->
		<link rel="shortcut icon" href="{{ asset ('template/assets/demo/default/media/img/logo/favicon.ico')}}" />
	</head>
	<!-- end::Head -->
    <!-- end::Body -->
										...
										<li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" m-dropdown-toggle="click">
											<a href="#" class="m-nav__link m-dropdown__toggle">
												<span class="m-topbar__userpic">
													<img src="{{ asset ('template/assets/app/media/img/users/user4.jpg')}}" class="m--img-rounded m--marginless m--img-centered" alt=""/>
												</span>
								...
								<div class="m-portlet m-portlet--bordered-semi m-portlet--full-height ">
									...
									<div class="m-portlet__body">
										...
										<div class="m-widget4">
											...
											<div class="m-widget4__item">
												<div class="m-widget4__img m-widget4__img--logo">
													<img src="{{ asset ('template/assets/app/media/img/client-logos/logo2.png')}}" alt="">
												</div>
												<div class="m-widget4__info">
													<span class="m-widget4__title">
														AirApp
									...
									<div class="m-portlet__body">
										<div class="m-widget19">
											<div class="m-widget19__pic m-portlet-fit--top m-portlet-fit--sides" style="min-height-: 286px">
												<img src="{{ asset ('template/assets/app/media/img//blog/blog1.jpg')}}" alt="">
									...
									<div class="m-portlet__body">
										<div class="m-widget27 m-portlet-fit--sides">
											<div class="m-widget27__pic">
												<img src="{{ asset ('template/assets/app/media/img//bg/bg-4.jpg')}}" alt="">
												...
												<div class="m-timeline-2__items  m--padding-top-25 m--padding-bottom-30">
													...
													<div class="m-timeline-2__item m--margin-top-30">
														...
														<div class="m-list-pics m-list-pics--sm m--padding-left-20">
															<a href="#">
																<img src="{{ asset ('template/assets/app/media/img/users/100_4.jpg')}}" title="">
															</a>
															<a href="#">
																<img src="{{ asset ('template/assets/app/media/img/users/100_13.jpg')}}" title="">
															</a>
															<a href="#">
																<img src="{{ asset ('template/assets/app/media/img/users/100_11.jpg')}}" title="">
															</a>
															<a href="#">
																<img src="{{ asset ('template/assets/app/media/img/users/100_14.jpg')}}" title="">
															</a>
														</div>
													</div>
													<div class="m-timeline-2__item m--margin-top-30">
...
<!--Begin::Section-->
								...
								<div class="m-portlet m-portlet--bordered-semi m-portlet--full-height ">
									...
									<div class="m-portlet__body">
										<div class="m-widget4">
											<div class="m-widget4__item">
												<div class="m-widget4__img m-widget4__img--logo">
													<img src="{{ asset ('template/assets/app/media/img/client-logos/logo5.png')}}" alt="">
												</div>
												<div class="m-widget4__info">
													<span class="m-widget4__title">
														Trump Themes
											...
											<div class="m-widget4__item">
												<div class="m-widget4__img m-widget4__img--logo">
													<img src="{{ asset ('template/assets/app/media/img/client-logos/logo4.png')}}" alt="">
												</div>
												<div class="m-widget4__info">
													<span class="m-widget4__title">
														StarBucks
											...
											<div class="m-widget4__item">
												<div class="m-widget4__img m-widget4__img--logo">
													<img src="{{ asset ('template/assets/app/media/img/client-logos/logo3.png')}}" alt="">
												</div>
												<div class="m-widget4__info">
													<span class="m-widget4__title">
														Phyton
											...
											<div class="m-widget4__item">
												<div class="m-widget4__img m-widget4__img--logo">
													<img src="{{ asset ('template/assets/app/media/img/client-logos/logo1.png')}}" alt="">
												</div>
												<div class="m-widget4__info">
													<span class="m-widget4__title">
														FlyThemes
								...
								<div class="m-messenger__wrapper">
									<div class="m-messenger__message m-messenger__message--in">
										<div class="m-messenger__message-pic">
											<img src="{{ asset ('template/assets/app/media/img//users/user3.jpg')}}" alt=""/>
										</div>
		...
		<!-- begin::Quick Nav -->	
    	<!--begin::Base Scripts -->
		<script src="{{ asset ('template/assets/vendors/base/vendors.bundle.js')}}" type="text/javascript"></script>
		<script src="{{ asset ('template/assets/demo/default/base/scripts.bundle.js')}}" type="text/javascript"></script>
		<!--end::Base Scripts -->   
        <!--begin::Page Vendors -->
		<script src="{{ asset ('template/assets/vendors/custom/fullcalendar/fullcalendar.bundle.js')}}" type="text/javascript"></script>
		<!--end::Page Vendors -->  
        <!--begin::Page Snippets -->
		<script src="{{ asset ('template/assets/app/js/dashboard.js')}}" type="text/javascript"></script>
		<!--end::Page Snippets -->
	</body>
	<!-- end::Body -->
</html>
